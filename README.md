...
Again, the crucial take-away is that the context used _inside_ the function
...
That said, this rule fits our general guideline about "what's to the left of
the dot." It's for convenience and feels "natural" from a linguistic point of
...
with JavaScript.  Those environments are also called runtimes.
...
Tests and labs will only test what makes sense to us. Take the initative to own
your own learning and try out these samples (with some variation!) in a runtime
of your choice.
